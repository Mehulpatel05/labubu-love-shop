...
-- Update orders RLS: authenticated users can see their own orders, admins can see all
...
CREATE POLICY "Authenticated users can place orders" ON public.orders FOR INSERT TO authenticated WITH CHECK (user_id = auth.uid());
